...
static php_stream *PCS_Stream_openfile(php_stream_wrapper * wrapper, PHP7_CONST char *uri, PHP7_CONST char *mode, int options, OPENED_PATH_PTR *opened_path, php_stream_context *context STREAMS_DC TSRMLS_DC);
static int PCS_Stream_url_stat(php_stream_wrapper *wrapper, PHP7_CONST char *uri, int flags, php_stream_statbuf *ssb, php_stream_context *context TSRMLS_DC);
static php_stream *PCS_Stream_opendir(php_stream_wrapper * wrapper, PHP7_CONST char *uri, PHP7_CONST char *mode, int options, OPENED_PATH_PTR *opened_path, php_stream_context *context STREAMS_DC TSRMLS_DC);
